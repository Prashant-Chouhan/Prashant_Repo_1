...
function runDemo(options, done) {
  var o = merge({
    ...
    data: nm.View,
    ctrlOptions: {},
    initDB: function () {nm.View.nodeMap},
  }, options)
...
function loadDefault(db, done) {
  ...
  db.save('root', ROOT_ID, {id: ROOT_ID}, function () {
    ...
    getTreeName : function getTreeName(){
     	  ...
     	  xmlhttp.open("GET","getRecentlyAddedTreeNameData.view",false);
     	  xmlhttp.send();
...
tmerge(DefaultNode.prototype, {
  ...
  setupNode: function () {
    ...
    input.setAttribute('id','selectData')
    input.setAttribute('multiple','true')
    input.setAttribute('onchange','IfPromptRequired()')
  ...
  stopEditing: function () {
    ...
    //var value = this.input.options[this.input.selectedIndex].text;
   // alert(this.input.options[this.input.selectedIndex].text);
    
    var value = "";
    try{
    for (var i=0; i<this.input.options.length; i++){
    	 if (this.input.options[i].selected==true){
    		 value  = value + this.input.options[i].text +" / " ;
    	 }
    	}
    }catch(err){
...
(1)
 ...
 // *********** CODE FOR CUSTOMIZATON **************** //

     function getSelectOptions(ele){
    	  ...
    	  xmlhttp.onreadystatechange=function()
    	    ...
    	    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    	      {
    	    	ele.input.innerHTML = (xmlhttp.responseText);
    	      }
    	    }
    	  xmlhttp.open("GET","getSelectOptionsData.view",true);
    	  xmlhttp.send();
     ...
     function ShowEvents(){
    	   var xmlhttp;
    	   var val = document.getElementById('selectBoxOptions').value;
    	  if (window.XMLHttpRequest)
    	    {// code for IE7+, Firefox, Chrome, Opera, Safari
    	    xmlhttp=new XMLHttpRequest();
    	    }
    	  ...
    	  xmlhttp.onreadystatechange=function()
    	    ...
    	    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    	      {
    	    	var ele = document.getElementById('selectBoxEvents');
    	    	ele.innerHTML=xmlhttp.responseText;
    	      }
    	    }
    	  xmlhttp.open("GET","getEventsData.view?option="+val,true);
    	  xmlhttp.send();
     }
     ...
     function ShowEventOptions(){
    	   var xmlhttp;
    	   var val = document.getElementById('selectBoxEvents');
    	  if (window.XMLHttpRequest)
    	    {// code for IE7+, Firefox, Chrome, Opera, Safari
    	    xmlhttp=new XMLHttpRequest();
    	    }
    	  ...
    	  xmlhttp.onreadystatechange=function()
    	    ...
    	    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    	      {
    	    	var ele = document.getElementById('selectBoxEventOptions');
    	    	ele.innerHTML=xmlhttp.responseText;

    	      }
    	    }
    	  xmlhttp.open("GET","getEventOptionsData.view?option="+val,true);
    	  xmlhttp.send();
     }
     

     function ShowEventOptionsResultant(ele){
    	   var xmlhttp;
    	  if (window.XMLHttpRequest)
    	    {// code for IE7+, Firefox, Chrome, Opera, Safari
    	    xmlhttp=new XMLHttpRequest();
    	  ...
    	  xmlhttp.onreadystatechange=function()
    	    ...
    	    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    	      {
    	    	ele.node.innerHTML = ele.node.innerHTML + xmlhttp.responseText;
    	      }
    	    }
    	//  xmlhttp.open("GET","getEventOptionsData.view?resultant="+val,true);
    	  xmlhttp.send();
     }
     
     function IfPromptRequired(){
    	 if(document.getElementById("selectData").selectedIndex == 0)
    	 {
        	  var label = prompt("Please enter label", "");
    	      if (label != null) 
    	      {
    	    	var x = document.getElementById("selectData");
